...
# Force remove if there is an issue like this
#     podman ps --all
#   podman rm --force 5342b92557d9
...
for node in $(kind get nodes --name k8-cluster-2node); do
  echo "Adding registry to nodes $node"
